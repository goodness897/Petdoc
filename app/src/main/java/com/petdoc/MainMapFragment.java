...
public class MainMapFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        Log.i("MainActivity","MainMapFragment onCreateView 실행");
    ...
    public void onResume() {
        super.onResume();
        Log.i("MainActivity","MainMapFragment onResume 실행");
        if (map == null){
            map = fragment.getMap();
            if(doc_list.size() > 0){
                doc_list.clear();
        ...
        map.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                if(callback != null){
                    Log.i("MainActivity","MainMapFragment callback 실행, id 값 : " + id);
    ...
    public void onPause() {
        ...
        Log.i("MainActivity", "MainMapFragment onPause 실행");
